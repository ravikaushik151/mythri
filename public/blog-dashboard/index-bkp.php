    ...
    <table class="table table-striped" id="postsTable">
        ...
        <?php foreach($posts as $index => $post): ?>
            <tr>
                ...
                <td>
                    <a href="add_edit_post.php?edit=<?= $index ?>" class="btn btn-sm btn-outline-primary">Edit</a>
                    <a href="delete_post.php?index=<?= $index ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Delete this post?')">Delete</a>
                </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
