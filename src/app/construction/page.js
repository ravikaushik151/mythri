            ...
            <div className="position-relative text-white d-flex align-items-md-center align-items-end" style={{ height: '100vh' }}>
              ...
              <div className="container position-relative z-1">
                <div className="d-flex my-md-0 my-5 py-md-0 py-4">
                  <div>
                    <h1 className="display-4 fw-bold mb-3 w-100 text-center">Luxury reimagined in green. <br />Welcome to Mythri Builders</h1>
          ...
          <section className="section-1 px-md-5 px-3 theme-bg-light home-about" >
            <div className="content">
              ...
              <p className="mt-4 theme-color-dark">
                At Mythri Builders, we’re redefining the future of real estate with a strong vision to build premium communities that balance modern living with environmental responsibility.<br />
